...
export function HeroBackground({
  ...
  backgroundImage = {
    light: "/hero-background-light.jpg",
    dark: "/hero-background-dark.jpg",
    alt: "Hero Background",
  },
}: HeroBackgroundProps) {
  const { resolvedTheme } = useTheme();
  const imageSrc = resolvedTheme === "dark" ? backgroundImage.dark : backgroundImage.light;
  ...
  return (
    <div className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden bg-background">
      {/* Background Image */}
      ...
      <div className="relative z-10 w-full">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-base sm:text-lg md:text-xl text-foreground/60 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto">
              {description}
            </p>
          </motion.div>
